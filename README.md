...
|----------|--------------|-----------------|
| **US Adult Income** | Predicts income level from census data using feature engineering and model comparison across multiple machine learning approaches. | MLP, Linear Regression, Random Forest, Classification | 
